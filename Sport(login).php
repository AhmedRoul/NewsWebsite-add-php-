...
<li><a class="linka active" href="Sport(login).php">Sports</a></li>
...
<a href="Sport(login).html"> Sport</a>
</div>
<br>
  <div class="bigOneSec">
...
<div class="bigOneSec">  <!--  add News---->
   <a href="(login).html" > <h3 class="link0" style="text-align:center; height:10px;"></h3></a>
  </div>
