...
<a href="Home(logout).html "><img style="padding-left:200px; border-left:1px solid #333;" src="imghome/AR11.png" alt="AR"height="40px"width="150px"/>
</div>

<div class="main20" >
<ul>
<li class="all">
<a class="linka  active" href="Home(logout).php">Home</a></li>
<li><a class="linka" href="#">News</a></li>
<li><a class="linka" href="Sport(logout).php">Sports</a></li>
<li><a class="linka" href="#">Health</a></li>
<li><a class="linka" href="Science(logout).php">Science</a></li>
<li><a class="linka" href="Technology(logout).php">Technology</a></li>
<li><a class="linka" href="Money(logout).php">Money</a></li>
<li><a class="linka" href="#">Travel</a></li>
</ul>
</div>
<div class="main22">
<ul>
<li><a class="linka" href="BreakingNews(logout).php">Breaking News</a></li>
<li><a class="linka" href="#">World News</a></li>
<li><a class="linka" href="#">Events</a></li>
<li><a class="linka" href="#">Books</a></li> 
<li><a class="linka " href="covid19(logout).php">CoronaVirus</a></li>
<li><a class="linka" href="#">TVshowpiz</a></li>
<li><a class="linka" href="Home(login).php" ><b>logout</b></a></li>
<li><a class="linka" href="admin page.php"><b>Admin Page</b></a></li>
</ul>
</div>
...
<a href="BreakingNews(logout).php"> Breaking News</a>
</div>
...
<table  class="hovertable"  cellpadding="30"style=" cellspacing:9;">
	...
	<?php
		ShowTable("NEWSDATA/BreakingNews/", false);
	?>
	<tr><!--add News -->
		<td>
		<td> <a href="ReportsNews1(logout).html" >
		<!--img src ="Reports\11.jpg" height="130px" width="150px" style="float:right;"/-->
		<h2  class="linkText"> </h2> </a>
...
<div class="bigOneSec">
   <a href="BreakingNews(logout).php" > <h3 class="link0" style="text-align:center; height:10px;">more</h3></a>
  </div>
  <br>
  
  <!-- Science-->
<div class="titleArea"style="width:90%; padding-bottom:10px"; >
<a href="Science(logout).php">Science</a>
</div>
<br>
  <div class="bigOneSec">
     <a href="sciencenews-1(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="sciencenews-1(logout).html"> Spider-like toxins found in Australia's stinging trees </a>
         </h3>
  ...
  <div class="bigOneSec">
     <a href="sciencenews-2(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="sciencenews-2(logout).html"> Climate change: Earthquake 'hack' reveals scale of ocean warming </a>
         </h3>
     <p> Scientists have found a clever new way of measuring ocean warming, using sound waves from undersea earthquakes. </p>
     </div>
  </div>
  <div class="bigOneSec">
     <a href="sciencenews-3(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="sciencenews-3(logout).html">  'Total failure' on English river water quality </a>
         </h3>
  ...
  <?php 
	ShowDiv("NEWSDATA/Science/", false);
  ?>
  <div class="bigOneSec">  <!--  add News---->
   <a href="" > <h3 class="link0" style="text-align:center; height:10px;"></h3></a>
  </div>
  <div class="bigOneSec">
   <a href="Science(logout).php" > <h3 class="link0" style="text-align:center; height:10px">more</h3></a>
  </div>
  <br>
  <br>
...
<a href="Money(logout).php">Money</a>
</div>
...
<table  class="hovertable"  cellpadding="30"style=" cellspacing:9;">
<?php
	ShowTable("NEWSDATA/Money/", false);
?>
	<tr>  <!--add News-->
	<td>
		<td> <a href="ReportsNews1(logout).html" >
...
<div class="bigOneSec">
   <a href="Money(logout).php" > <h3 class="link0" style="text-align:center; height:10px;">more</h3></a>
  </div>
  <br>
  
  <!--Technology-->
<div class="titleArea"style="width:90%; padding-bottom:10px"; >
<a href="Technology(logout).php">
Technology</a>
</div>
<br>
  <div class="bigOneSec">
     <a href="technologynews-1(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="technologynews-1(logout).html"> Twitter beefs up security for US election candidates </a>
         </h3>
  ...
  <div class="bigOneSec">
     <a href="technologynews-2(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="technologynews-2(logout).html"> Google and Facebook under pressure to ban children's ads </a>
         </h3>
  ...
  <div class="bigOneSec">
     <a href="technologynews-3(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="technologynews-3(logout).html">  Canada Tesla driver charged over 'napping while speeding' </a>
         </h3>
  ...
  <?php
	ShowDiv("NEWSDATA/Technology/", false);
  ?>
  <div class="bigOneSec">  <!--  add News---->
  ...
  <div class="bigOneSec">
   <a href="Technology(logout).php" > <h3 class="link0" style="text-align:center; height:10px;">more</h3></a>
  </div>
  <br>
  
  <!----------------Sports----->
<div class="titleArea"style="width:90%; padding-bottom:10px"; >
<a href="Sport(logout).php"> Sport</a>
</div>
<br>
  <div class="bigOneSec">
     <a href="sportnews-1(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="sportnews-1(logout).html">  Gareth Bale signs for Tottenham: Opponents will worry about playing Spurs - Danny Murphy analysis </a>
         </h3>
     <p> Gareth Bale has that "wow" factor, something only a few very special players in the world have got. </p>
     </div>
  </div>
  <div class="bigOneSec">
     <a href="sportnews-2(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="sportnews-2(logout).html">  Liverpool sign Diogo Jota for £41m from Wolves as Ki-Jana Hoever moves to Molineux </a>
         </h3>
  ...
  <div class="bigOneSec">
     <a href="sportnews-3(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="sportnews-3(logout).html">  French Open 2020: Naomi Osaka pulls out with hamstring injury </a>
         </h3>
    ...
    <?php
	ShowDiv("NEWSDATA/Sports/", false);
  ?>
  <div class="bigOneSec">  <!--  add News---->
   <a href="" > <h3 class="link0" style="text-align:center; height:10px;"></h3></a>
  </div>
<div class="bigOneSec">
   <a href="Sport(logout).php" > <h3 class="link0" style="text-align:center; height:10px;">more</h3></a>
  </div>
...
<a href="Reports(logout).php"><p> Reports</p></a>
...
<table  class="hovertable"  cellpadding="30"style=" cellspacing:9;">
	...
	<tr>
		<td> <a href="ReportsNews1(logout).html" title="Sahl Hasheesh Divers Start a Campaign to Clean the Red Sea">
		<img src ="Reports\11.jpg" height="130px" width="150px" style="float:right;"/>
 ...
 including the environment and living organisms </td>
	...
	<tr>
		<td>
		<a href="ReportsNews2(logout).html" title="The “autumn star” adorns the dome of the sky starting today">
...
In the sky of the Arab world, starting from this evening until next month
	...
	<tr>
		<td>
		<a href="ReportsNews3(logout).html" title="The “autumn star” adorns the dome of the sky starting today">
...
<?php
		ShowTable("NEWSDATA/Reports/", false);
	?>
</table>
...
<div class="bigOneSec">
   <a href="Reports(logout).php" > <h3 class="link0" style="text-align:center; height:10px;">more</h3></a>
  </div>
<br>


<!--         covid19--->
 <div class="titleArea"style="width:90%; padding-bottom:1%"; ><a href="covid19.php"><p>covid19</p></a>

</div>
<br>
  <div class="bigOneSec" >
     <a href="covid19news-1(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="covid19news-1(logout).html">  New fear grips Europe as Covid tops 30m worldwide </a>
         </h3>
     <p> The number of confirmed coronavirus cases across the globe has surpassed 30 million, according to figures by America's Johns Hopkins University </p>
     </div>
  </div>
  <div class="bigOneSec">
     <a href="covid19news-2(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="covid19news-2(logout).html">  Coronavirus: How will the world vaccinate seven billion? </a>
         </h3>
     <p> Teams across the world are working to develop a vaccine that will be effective against Covid-19. </p>
     </div>
  </div>
  <div class="bigOneSec">
     <a href="covid19news-3(logout).html" class="bigOneImg">
     ...
     <div>
         <h3>
           <a href="covid19news-3(logout).html"> Step-by-step guide to making your own face mask </a>
         </h3>
  ...
  <?php
	ShowDiv("NEWSDATA/COVID-19/", false);
  ?>
  <div class="bigOneSec">  <!--  add News---->
   <a href="" > <h3 class="link0" style="text-align:center; height:10px;"></h3></a>
  </div>
  <div class="bigOneSec">
   <a href="covid19.php" > <h4 class="link0" style="text-align:center; height:10px;">more</h4></a>
  </div>
</div>
</div>
...
<div class="navbar">
  ...
  <tr style="border: none;" >
   <td style="border: none;" ><a href="BreakingNews(logout).php"class="Texttable" ><p  >BreakingNews</p></a></td>
 <td style="border: none;" ><a href="" class="Texttable"><p >Politics</p></a></td>
	 <td style="border: none;" ><a href="Reports(logout).php" class="Texttable"><p >Reports</p></a></td>
  </tr>
  
  <tr style="border: none;" >
   <td style="border: none;" ><a href="Technology(logout).php" class="Texttable"><p >Technology</p></a></td>
 <td style="border: none;" ><a href="Sport(logout).php" class="Texttable"><p >  Sport </p></a></td>
	 <td style="border: none;" ><a href="Money(logout).php" class="Texttable"><p >Money</p></a></td>
  </tr>
  <td style="border: none;" ><a href="covid19(logout).php" class="Texttable"><p >Crona Virus </p></a></td>
 <td style="border: none;" ><a href="Science(logout).php" class="Texttable"><p >Science</p></a></td>
  </tr>
...
function currentSlide(n) {
  showSlides(slideIndex = n);
  if (n==1){
  document.getElementsById(buttonimg1).style.backgroundColor="#de2323";
document.getElementsById(buttonimg2).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg3).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg4).style.backgroundColor="#515A5A";
}
else if(n==2)
{
 document.getElementsById(buttonimg2).style.backgroundColor="#de2323";
document.getElementsById(buttonimg1).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg3).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg4).style.backgroundColor="#515A5A";
...
{
 document.getElementsById(buttonimg3).style.backgroundColor="#de2323";
document.getElementsById(buttonimg1).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg2).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg4).style.backgroundColor="#515A5A";
}
 ...
 document.getElementsById(buttonimg4).style.backgroundColor="#de2323";
document.getElementsById(buttonimg1).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg).style.backgroundColor="#515A5A";
document.getElementsById(buttonimg2).style.backgroundColor="#515A5A";
}
}
